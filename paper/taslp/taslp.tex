...
Instead of a knee we identify a provisional \emph{saturation region} around
200--280\,ms, beyond which the average return per 20\,ms equivalent of added
lookahead over each sampled interval falls below the measured $2\sigma$
repeatability floor. At the 40\,ms lookahead used by PHONOS's translator, our
