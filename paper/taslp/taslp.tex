...
\textbf{The pattern does not hold within L1 either.} Splitting by native
language, the predicted direction appears in only 3 of 6 L1s and the ratio of
group gains straddles unity: Vietnamese $1.23$, Korean $1.19$, Arabic $1.08$,
Spanish $1.02$, Hindi $0.99$, Chinese $0.92$. A grouping that reverses across
half the languages in the corpus is not capturing a property of manner class.
These are six speakers, so the by-L1 split is descriptive rather than powered.
