...
Second, a pre-specified hypothesis that vowels and approximants would benefit
...
time, in a form we could not have quietly rewritten to match the outcome
without the rewrite itself being visible in the history. The prediction was
...
pre-specified manner grouping does not reliably order lookahead benefit.
...
condition. B = pre-specified as breaking first, S = as surviving. The
