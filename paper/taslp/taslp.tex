...
bottoming out at $160$\,ms. What survives the swap is the absence of evidence
...
\S\ref{sec:encoder} is two checkpoints at one seed, which is enough to show
that the exchange rate does not transfer but not to attribute the gap to
pretraining scale, objective or architecture; and each encoder is tapped at a
